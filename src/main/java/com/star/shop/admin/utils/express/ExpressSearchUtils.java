package com.star.shop.admin.utils.express;
...
//            parameters.add(new BasicNameValuePair("platform", "MWWW"));
            parameters.add(new BasicNameValuePair("temp", "0.860779312047019"));
            HttpEntity httpEntity = new UrlEncodedFormEntity(parameters);
            httpPost.setEntity(httpEntity);
    ...
    public static void main(String[] args) {
        // 查询物流公司
//		 System.out.println(getCompanyCodeByNumber("YT5076537918347"));
        // 查询物流信息
//    	ExpressReturnData data = getExpressInfoByCodeAndNumber(getCompanyCodeByNumber("YT5133887892911"), "YT5133887892911");
//    	ExpressReturnData data = getExpressInfoByCodeAndNumber(getCompanyCodeByNumber("557037328548747"), "557037328548747");
//    	ExpressReturnData data = getExpressInfoByCodeAndNumber(getCompanyCodeByNumber("4309988344160"), "4309988344160");
//        List<ExpressInfo> list = data.getData();
//        System.out.println(data.getCom());
//        System.out.println(data.getNu());
//        for (ExpressInfo info : list) {
